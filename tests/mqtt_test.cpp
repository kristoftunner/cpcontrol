...
int main(int argc, char* argv[])
{
  ...
  config cfg;
  cfg.clientId = "asd";
  cfg.server = "tcp://localhost:1883"; 
  cfg.password = "passwd";
  cfg.userName = "user";
  std::shared_ptr<mqtt::client> cli = std::make_shared<mqtt::client>(cfg.server, cfg.clientId);
    ...
    if(cli->is_connected())
      ...
      std::cout << "not connected" << std::endl;
        ...
        std::string message = "hello world";
				cli->publish(std::string("hello"), message.data(), message.size());
