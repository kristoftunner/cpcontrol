...
set(MODBUS_DIR ${CMAKE_CURRENT_SOURCE_DIR}/lib/libmodbus)
...
message(STATUS "static lib: ${MODBUS_STATIC_LIB} , bin dir: ${MODBUS_BIN}, modbus dir: ${MODBUS_DIR}, includes: ${MODBUS_INCLUDES}")
